...
Revision ID: 96f5f6b5e095
Revises: 
Create Date: 2026-02-18 01:18:48.815904
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('type', sa.Enum('FOTO', 'VIDEO', 'AUDIO', name='mediatype'), nullable=False),
